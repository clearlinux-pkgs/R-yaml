...
Version  : 2.1.18
Release  : 40
URL      : https://cran.r-project.org/src/contrib/yaml_2.1.18.tar.gz
Source0  : https://cran.r-project.org/src/contrib/yaml_2.1.18.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1520777520
