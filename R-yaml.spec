...
Version  : 2.3.6
Release  : 86
URL      : https://cran.r-project.org/src/contrib/yaml_2.3.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/yaml_2.3.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666102697
