...
Version  : 2.1.15
Release  : 33
URL      : https://cran.r-project.org/src/contrib/yaml_2.1.15.tar.gz
Source0  : https://cran.r-project.org/src/contrib/yaml_2.1.15.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1512433166
