...
Version  : 2.1.16
Release  : 35
URL      : https://cran.r-project.org/src/contrib/yaml_2.1.16.tar.gz
Source0  : https://cran.r-project.org/src/contrib/yaml_2.1.16.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1513200657
