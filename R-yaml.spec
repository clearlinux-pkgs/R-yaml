...
Version  : 2.3.5
Release  : 84
URL      : https://cran.r-project.org/src/contrib/yaml_2.3.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/yaml_2.3.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645467819
